...
- Збереження персональних налаштувань (історія/закріплені адреси) у `data/users.json (ключі — chat_id)`, включно з `auto_update` (enabled/interval).
...
- Доступне автооновлення графіка: **увімкнути/вимкнути** та вибір інтервалу **30с / 60с / 120с** (мінімум 10с).
